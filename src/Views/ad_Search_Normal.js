        ...
        <AdNavbar />
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-6">
                <a href="/ad_curhistory" className="btn btn-outline-info btn-lg btn-block">Recurring Booking</a>
              </div>
            </div>
            <br/>
            <br/>
            ...
            <center><button type="button" className="btn btn-outline-info">Search</button></center>
